<%-- 
    Document   : alteracaodadosveiculo
    Created on : Feb 5, 2017, 2:55:46 PM
    Author     : ssdorneles
--%>
...
<html>
    ...
    <body>
        ...
        <% Veiculo veiculo = (Veiculo) request.getAttribute("veiculo");
            ...
            cal.setTime(veiculo.getDataAquisicao());
            int dia = cal.get(Calendar.DAY_OF_MONTH);
            int mes = cal.get(Calendar.MONTH);
            int ano = cal.get(Calendar.YEAR);
            String cilindradasStr = veiculo.getCilindradas().toString().replace(".", ",");
            String capacidadeCargaStr = veiculo.getCapacidadeCarga().toString().replace(".", ",");
            String odometroAtualStr = veiculo.getOdometroAtual().toString().replace(".", ",");
        %>

        <form id="form_10712" class="appnitro"  method="post" action="alteracaodadosveiculo">
            ...
            <ul >
                <li id="li_15" >
                    ...
                    <span>
                        ...
                        <input id="element_1" name="placa" class="element text small" type="text" maxlength="255" value="<%=veiculo.getPlaca()%>" readonly/> 
                    </span>
                    <span>
                        <label class="description" for="element_2">Chassi* </label>
                        <input id="element_2" name="chassi" class="element text medium" type="text" maxlength="255" value="<%=veiculo.getChassi()%>" required="required"/> 
                    </span>
                    <span>
                        <label class="description" for="element_3">Renavam* </label>
                        <input id="element_3" name="renavam" class="element text medium" type="text" maxlength="255" value="<%=veiculo.getRenavam()%>" required="required"/> 
                ...
                <li id="li_4" >
                    <span style="width:45%;">
                        ...
                        <input id="element_4" name="fabricante" class="element text medium" type="text" maxlength="255" value="<%=veiculo.getFabricante()%>" required="required"/> 
                    </span>
                    <span style="width:45%;">
                        <label class="description" for="element_5">Modelo* </label>
                        <input id="element_5" name="modelo" class="element text medium" type="text" maxlength="255" value="<%=veiculo.getModelo()%>" required="required"/> 
                    </span>
                ...
                <li id="li_6" >
                    <span style="width:20%;">
                        ...
                        <input id="element_6" name="anoFabricacao" class="element text small" type="text" maxlength="255" value="<%=veiculo.getAnoFabricacao()%>" required="required"/> 
                    </span>

                    <span style="width:20%;">
                        <label class="description" for="element_7">Ano de modelo* </label>
                        <input id="element_7" name="anoModelo" class="element text small" type="text" maxlength="255" value="<%=veiculo.getAnoModelo()%>" required="required"/> 
                    </span>
                    <span style="width:30%;">
                        <label class="description" for="element_8">Data de aquisição* </label>
                        <span style="margin-right: 4px">
                            <input id="element_8_1" name="dataAquisicaoDD" class="element text" size="2" maxlength="2" value="<%=dia%>" type="text" required="required"> /
                            <label for="element_8_1">DD</label>
                        </span>
                        <span style="margin-right: 4px">
                            <input id="element_8_2" name="dataAquisicaoMM" class="element text" size="2" maxlength="2" value="<%=mes%>" type="text" required="required"> /
                            <label for="element_8_2">MM</label>
                        </span>
                        <span style="margin-right: 4px">
                            <input id="element_8_3" name="dataAquisicaoAAAA" class="element text" size="4" maxlength="4" value="<%=ano%>" type="text" required="required">
                    ...
                    <div>
                        <input id="element_9" name="cilindradas" class="element text small" type="text" maxlength="255" value="<%=cilindradasStr%>" required="required"/> 
                    </div> 
                </li>		<li id="li_10" >
                    <label class="description" for="element_10">Número de passageiros* </label>
                    <div>
                        <input id="element_10" name="capacidadePessoas" class="element text small" type="text" maxlength="255" value="<%=veiculo.getCapacidadePessoas()%>" required="required"/> 
                    </div> 
                </li>		<li id="li_11" >
                    <label class="description" for="element_11">Capacidade de carga (Kg)* </label>
                    <div>
                        <input id="element_11" name="capacidadeCarga" class="element text small" type="text" maxlength="255" value="<%=capacidadeCargaStr%>" required="required"/> 
                    </div> 
                </li>		<li id="li_12" >
                    <label class="description" for="element_12">Cor* </label>
                    <div>
                        <input id="element_12" name="cor" class="element text medium" type="text" maxlength="255" value="<%=veiculo.getCor()%>" required="required"/> 
                    </div> 
                </li>		<li id="li_17" >
                    ...
                    <div>
                        <input id="element_13" name="odometroAtual" class="element text small" type="text" maxlength="255" value="<%=odometroAtualStr%>" required="required"/> 
                    </div> 
                </li>		<li id="li_18" >
                    ...
                    <div>
                        <textarea id="element_14" name="observacao" class="element textarea medium"><%=veiculo.getObservacao()%></textarea> 
                    </div> 
                </li>
            </ul>
            <br>
            <center>
                <input id="saveForm" class="button_text" type="submit" name="submit" value="Salvar alterações" />
            </center>
        </form>	
    </body>
</html>