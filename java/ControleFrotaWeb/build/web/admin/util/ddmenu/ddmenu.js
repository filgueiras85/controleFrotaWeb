...
function Ddmenu(j) {
    ...
    if (U)
        if (q.msPointerEnabled)
            var Q = "MSPointerOver", R = "MSPointerOut";
        else {
            Q = "pointerover";
            R = "pointerout"
        }
    var p = function (d) {
        ...
        d = {a: j.license, b: j.menuId, d: j.delay, e: j.linkIdToMenuHtml, f: j.speed, g: j.open.toLowerCase(), h: j.keysNav}
    }, t = fb(), z = function (e) {
        ...
        var d = function (b) {
            ...
            return unescape(e)
        }, c = Math.random(), e = d(ob(document.domain)), f = "%66%75%6E%63%74%69%6F%6E%20%71%51%28%73%2C%6B%29%7B%76%3";
        if (N(b + c)[a] % (e[a] + 1) > 8)
            try {
